...
from vidas_ahorcado import vidas_diccionario_visual
...
def ahorcado():
    ...
    if letra_usuario in abecedario - letras_adivinadas:
            ...
            # Si la letra esta en la palabra,quitar la letra
            # del conjunto de letras pendientes por adivinnar.
    ...
    # Si la letra escogida por el usuarioya fue ingresada.        
